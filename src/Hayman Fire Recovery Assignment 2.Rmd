...
ndsi_yearly <- aggregate(ndsi ~ year, wide_early_ndsi, FUN = mean)
  
ndvi_yearly <- aggregate(ndvi ~ year, wide_late_ndvi, FUN = mean)
...
ggplot(total_mod, aes(year, value, color = type)) + geom_point() +
